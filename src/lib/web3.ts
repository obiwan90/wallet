...
export const COMMON_TOKENS: Record<number, TokenInfo[]> = {
  1: [ // Ethereum mainnet - using verified addresses
    createTokenInfo('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 'WETH', 'Wrapped Ether', 18, 1),
    createTokenInfo('0xA0b86a33E6441cc2bbC9dd1c6A8beD47aA00E5e4', 'USDC', 'USD Coin', 6, 1),
    ...
    createTokenInfo('0x514910771AF9Ca656af840dff83E8264EcF986CA', 'LINK', 'Chainlink', 18, 1),
    createTokenInfo('0x7D1AfA7B718fb893dB30A3aBc0Cfc608AaCfeBB0', 'MATIC', 'Polygon', 18, 1),
    createTokenInfo('0x6B175474E89094C44Da98b954EedeAC495271d0F', 'DAI', 'Dai Stablecoin', 18, 1),
    createTokenInfo('0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE', 'SHIB', 'Shiba Inu', 18, 1)
  ],
  137: [ // Polygon
    createTokenInfo('0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270', 'WMATIC', 'Wrapped Matic', 18, 137),
    ...
    createTokenInfo('0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619', 'WETH', 'Wrapped Ether', 18, 137),
    createTokenInfo('0xb33EaAd8d922B1083446DC23f610c2567fB5180f', 'UNI', 'Uniswap', 18, 137),
    createTokenInfo('0x53E0bca35eC356BD5ddDFebbD1Fc0fD03FaBad39', 'LINK', 'Chainlink', 18, 137),
    createTokenInfo('0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063', 'DAI', 'Dai Stablecoin', 18, 137),
    createTokenInfo('0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6', 'WBTC', 'Wrapped Bitcoin', 8, 137)
  ],
  56: [ // BSC
    createTokenInfo('0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 'WBNB', 'Wrapped BNB', 18, 56),
    ...
    createTokenInfo('0x2170Ed0880ac9A755fd29B2688956BD959F933F8', 'ETH', 'Ethereum Token', 18, 56),
    createTokenInfo('0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402', 'DOT', 'Polkadot Token', 18, 56),
    createTokenInfo('0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD', 'LINK', 'Chainlink', 18, 56),
    createTokenInfo('0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE', 'XRP', 'XRP Token', 18, 56),
    createTokenInfo('0x1CE0c2827e2eF14D5C4f29a091d735A204794041', 'AVAX', 'Avalanche Token', 18, 56)
  ],
  43114: [ // Avalanche
    createTokenInfo('0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7', 'WAVAX', 'Wrapped AVAX', 18, 43114),
    createTokenInfo('0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E', 'USDC', 'USD Coin', 6, 43114),
    createTokenInfo('0x9702230A8Ea53601f5cD2dc00fDBc13d4dF4A8c7', 'USDT', 'Tether USD', 6, 43114),
    createTokenInfo('0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB', 'WETH', 'Wrapped Ether', 18, 43114),
    createTokenInfo('0x5947BB275c521040051D82396192181b413227A3', 'LINK', 'Chainlink', 18, 43114),
    createTokenInfo('0xd586E7F844cEa2F87f50152665BCbc2C279D8d70', 'DAI', 'Dai Stablecoin', 18, 43114)
  ],
  42161: [ // Arbitrum
    createTokenInfo('0x82aF49447D8a07e3bd95BD0d56f35241523fBab1', 'WETH', 'Wrapped Ether', 18, 42161),
    createTokenInfo('0xA0b86a33E6441cc2bbC9dd1c6A8beD47aA00E5e4', 'USDC', 'USD Coin', 6, 42161),
    createTokenInfo('0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9', 'USDT', 'Tether USD', 6, 42161),
    createTokenInfo('0xFa7F8980b0f1E64A2062791cc3b0871572f1F7f0', 'UNI', 'Uniswap', 18, 42161),
    createTokenInfo('0xf97f4df75117a78c1A5a0DBb814Af92458539FB4', 'LINK', 'Chainlink', 18, 42161),
    createTokenInfo('0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1', 'DAI', 'Dai Stablecoin', 18, 42161)
  ],
  10: [ // Optimism
    createTokenInfo('0x4200000000000000000000000000000000000006', 'WETH', 'Wrapped Ether', 18, 10),
    createTokenInfo('0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85', 'USDC', 'USD Coin', 6, 10),
    createTokenInfo('0x94b008aA00579c1307B0EF2c499aD98a8ce58e58', 'USDT', 'Tether USD', 6, 10),
    createTokenInfo('0x6fd9d7AD17242c41f7131d257212c54A0e816691', 'UNI', 'Uniswap', 18, 10),
    createTokenInfo('0x350a791Bfc2C21F9Ed5d10980Dad2e2638ffa7f6', 'LINK', 'Chainlink', 18, 10),
    createTokenInfo('0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1', 'DAI', 'Dai Stablecoin', 18, 10)
  ],
  8453: [ // Base
    createTokenInfo('0x4200000000000000000000000000000000000006', 'WETH', 'Wrapped Ether', 18, 8453),
    createTokenInfo('0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913', 'USDC', 'USD Coin', 6, 8453),
    createTokenInfo('0x50c5725949A6F0c72E6C4a641F24049A917DB0Cb', 'DAI', 'Dai Stablecoin', 18, 8453),
    createTokenInfo('0x940181a94A35A4569E4529A3CDfB74e38FD98631', 'AERO', 'Aerodrome', 18, 8453)
  ]
};
